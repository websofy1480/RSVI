  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        formbg: "rgb(var(--color-formbg) / <alpha-value>)",
        MidnightNavyText: "rgb(var(--color-midnight) / <alpha-value>)",
        SlateBlueText: "rgb(var(--color-slate) / <alpha-value>)",
        learning: "rgb(var(--color-learning) / <alpha-value>)",
        primaryPink: "rgb(var(--color-primary-pink) / <alpha-value>)",
        burntOrange: "rgb(var(--color-burnt-orange) / <alpha-value>)",
        goldenOrange: "rgb(var(--color-golden-orange) / <alpha-value>)",
