        ...
        <div className="flex items-center justify-between w-[120%] gap-2 px-3 py-3 border-b border-SlateBlueText/20 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          ...
          <Link href="/" className="flex justify-center items-center lg:hidden">
            ...
            <div className="w-full">
              <h6 className="ml-2 text-center text-primary font-semibold text-[5px]">Rehabilitation Society of the Visually Impaired (RSVI)</h6>
            </div>
          </Link>
          <button
          ...
          <div className="hidden lg:block w-[40em] text-primary">
            <h1 className="ml-2 text-center font-semibold text-2xl">Rehabilitation Society of the Visually Impaired (RSVI)</h1>
          </div>
        </div>
        <div
