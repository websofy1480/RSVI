...
import { FaAward, FaInfinity } from "react-icons/fa6";
...
export const navItems: NavItem[] = [
  ...
  {
    name: "Internship",
    icon: <PiHandCoinsBold size={18} />,
    path: "/admin/internship"

  },
  {
    name: "Initiatives",
    icon: <FaInfinity size={18} />,
  ...
  {
    name: "Join Us Request",
    icon: <MdJoinInner size={18} />,
    path: "/admin/join-us-request"
  },
  {
    name: "Collaborator",
