    ...
    <div className="relative flex flex-col gap-5 items-center w-full">
      <div className="w-full flex justify-center">
        {preview ? (
          ...
          <div className="w-full md:w-full h-56 flex items-center justify-center border-2 border-dashed border-gray-300 rounded-lg bg-gray-50 text-gray-400 text-sm">
        ...
        <div className="relative w-full h-80 bg-black/80 rounded-lg overflow-hidden">
          ...
          <div className="absolute bottom-3 left-0 right-0 flex flex-col gap-2 items-center bg-white/80 p-3">
            ...
            <div className="flex gap-3 mt-2">
              ...
              <Button type="button" onClick={handleCropUpload}>
      ...
      {!cropMode && (
        ...
        >
          <p className="text-gray-600 text-sm sm:text-base">
            {loading ? "Uploading..." : `Click or drop to upload ${label.toLowerCase()}`}
          </p>
        </div>
      )}
