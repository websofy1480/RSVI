      ...
      <div className="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
        <div>
          <div className="mb-5 sm:mb-8">
            <h1 className="mb-2 font-semibold text-primary text-28 sm:text-36">
              Sign In
            </h1>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <Link
                    ...
                    className="text-sm items-center flex text-learning hover:text-learning/80"
                  >
                    <Key size={15} className="mr-2 mt-1" /> Forget password?
                  </Link>
                  <Link
                    href="/"
                    className="text-sm flex text-learning hover:text-learning/80"
                  >
