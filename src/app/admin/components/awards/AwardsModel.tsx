...
export const AwardsModel: React.FC<ModalProps & { initialData?: initiatives }> = ({ mode, onClose, onSave, initialData, loading, setLoading, showTooltip, tooltip }) => {
  ...
  return (
    <div className="fixed inset-0 bg-opacity-50 flex items-center justify-center z-[9999] bg-black/60" onClick={onClose}>
      ...
      >
        ...
        {mode === "delete" ? (
          <p>Are you sure want to delete this award?</p>
        ) : (
          <>
