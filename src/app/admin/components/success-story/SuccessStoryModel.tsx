...
export const SuccessStoryModel: React.FC<ModalProps & { initialData?: successStory }> = ({ mode, onClose, onSave, initialData, loading, setLoading, showTooltip, tooltip }) => {
  ...
  return (
    <div className={"fixed inset-0 bg-opacity-50 flex items-center justify-center z-[9999] bg-black/60"} onClick={onClose}>
      ...
      <div
        ...
        {mode === "delete" ? (
          <p>Are you sure want to delete this success story?</p>
        ) : (
          <>
            <div className="space-y-4">
              ...
              <div className="w-full">
                ...
                <textarea
                  ...
                  placeholder="What about your success story..."
                  rows={5}
                  onChange={handleChange}
