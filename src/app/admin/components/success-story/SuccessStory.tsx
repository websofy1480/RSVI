...
export default function SuccessStory() {
  ...
  const fetchData = async () => {
    const internshipRes = await fetch("/api/auth/success-story");
  ...
  return (
    <div className="p-4">
      ...
      {
        showDescription && <MessageModel closedModel={setShowDescription} data={internshipDescription} mode="success-story" />
      }
    </div>
  );
}
