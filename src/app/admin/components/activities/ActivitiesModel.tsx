...
export default function ActivitiesModel({ mode, onClose, onSave, initialData }: any) {
    ...
    <div className="fixed inset-0 bg-opacity-50 flex items-center justify-center z-[9999] bg-black/60" onClick={onClose}>
      ...
      >
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-xl font-semibold">{mode === "edit" ? "Update" : mode === "delete" ? "Delete" : "Add"} Activity</h2>
          <button
            onClick={onClose}
            ...
            <div className="space-y-4">
              ...
              <div className="w-full">
                ...
                <textarea
                  ...
                  placeholder="About your activity..."
                  rows={5}
                  onChange={handleChange}
                  className="resize-none border border-formbg shadow-md shadow-formbg/50 outline-none w-full p-2 rounded"
                />
              </div>
